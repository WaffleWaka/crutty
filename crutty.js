class crutty {
    ...
    connect (params){
        var config = {
            ...
            port:  parseInt(params.port) > 0 ? parseInt(param_port) : params.protocol == "telnet" ? 23 : 22, //Use default port 23 for telnet and 22 for SSH
...
asdf.connect({
    ...
    ssh_password: "oper",
    timeout: 30000,
    callback: telnetCallback,
})
function telnetCallback (a,b,c,d,e) {
    console.log(a)

    if (a && a.search("login:") >= 0){
        b.write("oper\r\n")
    } else if (a && a.search("::>") >= 0){
        b.write("who\r\n")
    }
}